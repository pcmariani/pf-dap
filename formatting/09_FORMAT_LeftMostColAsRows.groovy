    ...
    table.tr.eachWithIndex { tr, f ->
      ...
      if (markedForAction) {
        ...
        if (firstCellInRow.name() == "td") {
          ...
          def newtd = new Node(newtr, 'td', [colSpan:numCols, style:"width:100%; font-weight:bold; text-align:center;", id:firstCellInRow.@id] , categoryRowPrependText + (firstCellInRow.value()[0] as String))
